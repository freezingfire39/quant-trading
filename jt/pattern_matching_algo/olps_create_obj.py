...
c = conn.cursor()
conn = sqlite3.connect('TestDB_sec.db')
c = conn.cursor()
conn = sqlite3.connect('TestDB_thi.db')
c = conn.cursor()
# Study name for given strategies.
study_name = ['ftrl', 'ftl', 'pamr', 'cwmr', 'olmar1', 'olmar2', 'rmr',
...
for s_name in study_name:
    ...
    temp1 = optuna.create_study(study_name=s_name, storage='sqlite:///TestDB.db', direction='maximize')
    temp2 = optuna.create_study(study_name=s_name, storage='sqlite:///TestDB_sec.db', direction='maximize')
    temp3 = optuna.create_study(study_name=s_name, storage='sqlite:///TestDB_thi.db', direction='maximize')
