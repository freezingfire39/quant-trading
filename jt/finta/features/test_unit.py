...
df = pd.read_csv('AMD_dollar_all 2.csv', index_col="date_time", parse_dates=True)
ohlc = pd.read_csv('AMD_dollar_all 2.csv', index_col="date_time", parse_dates=True)
