...
class TA:
    ...
    @classmethod
    def CHAIKIN(cls, ohlcv: DataFrame, span_one: int = 3, span_two: int = 10) -> Series:
        ...
        return pd.Series(
            cls.ADL(ohlcv).ewm(span=span_one, min_periods=2).mean()
            - cls.ADL(ohlcv).ewm(span=span_two, min_periods=9).mean()
        )
